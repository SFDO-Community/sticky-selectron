//TODO: note that this whole class is very WIP and mish-mashed together
import { LightningElement, api, wire } from "lwc";
//import getFieldInformation from "@salesforce/apex/usf3.GetFieldInformation.getFieldInformation";

export default class StickySelectronFieldNamesBuilder extends LightningElement {
  _inputVariables = [];
  displayVol = false;
  //@wire(describeSObject, { type: "Account" }) wiredAccountFields;

  //@api builderContext;

  leftFieldOptions = ["one", "two"];
  rightFieldOptions = ["three", "four"];
